...
<p align="center"> 
<form method="POST"  name=form1 action="add_bizmid2.jsp" onsubmit="return condition()">
...
<table border="0" width="76%">
    <tr>
      ...
      <td width="70%" class="InputTip"><input type="text" name="biz_memo" size="20" value="<%=midObjectView.get_biz_memo().trim()%>"></td>
    </tr>
    <tr>
      <td width="30%" class="InputTip">
        <p align="right">简要功能说明：</td>
      <td width="70%" class="InputTip"><input type="text" name="biz_detail" size="50" value="<%=midObjectView.get_biz_detail().trim()%>"></td>
    </tr>
</table>
  <p align="center">　</p>
  <p align="center">　</p>
  <input type="hidden" name="biz_id" value="<%=i_biz_id%>">
  <p align="center"><input type="submit" value="下一步" name="B1"> <input type="reset" value="全部重写" name="B2"></p>
</form>
