...
<html>
    ...
    <form action="/personbank/HttpProxy" method="post" name="form1">
        <!-- 总行定义字段 -->
        <input type="hidden" name="URL" value="/midserv/Wel_hTen_Red.jsp"/>
        ...
        <table width="90%" align="center" cellpadding="1" cellspacing="1"  class="tab">
		 ...
		 <tr class="tab_tr"> 
	        ...
	        <td align="left"> 
				<SELECT name="Bus">
					<option value='<%=WelLot.HP_TEN_SUMMARY%>' selected="selected">业务简介</option>
					<option value='<%=WelLot.HP_TEN_BUY%>'>投注</option>
					<option value='<%=WelLot.HP_TEN_QRY%>'>投注查询</option>
					<option value='<%=WelLot.HP_TEN_WINQRY%>'>中奖查询</option>
				</SELECT>
	        </td>
	     </tr>
	     <tr class="tab_result"> 
